...
\begin{document}
	...
	\begin{anexosenv}
		...
		\includepdf[pages=-]{anexos/psc2023-e12-resultado-definitivo}
		
		\chapter{Relatório de Similaridade Aplicado no PSC 2023 (apenas algumas páginas)}
		\includepdf[pages=-]{anexos/psc2023-e12-relatorio-similaridade}
		
		\chapter{Relatório de Estatísticas de Processamento (apenas algumas páginas)}
		\includepdf[pages=-]{anexos/psc2023-e12-relatorio-processamento}
