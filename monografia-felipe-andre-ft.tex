...
\begin{document}
			...
			\subsection{Geradores de Relatório}
				...
				\begin{figure}[h]
					\begin{center}
						...
						\multicolumn{1}{|c|}{\textbf{PDFResultado}} &  & \multicolumn{1}{c|}{\textbf{PDFRetorno}} &  & \multicolumn{1}{c|}{\textbf{PDFSimilaridade}} \\ \cline{1-1} \cline{3-3} \cline{5-5} 
						&  &                                          &  &                                               \\ \cline{1-1} \cline{3-3} \cline{5-5} 
	...
	\begin{anexosenv}
		...
		\includepdf[pages=-]{anexos/psc2023-e12-resultado-definitivo.pdf}
		
		\chapter{Relatório de Similaridade Aplicado no PSC 2023 (apenas algumas páginas)}
		\includepdf[pages=-]{anexos/psc2023-e12-relatorio-similaridade.pdf}
		
		\chapter{Relatório de Estatísticas de Processamento (apenas algumas páginas)}
		\includepdf[pages=-]{anexos/psc2023-e12-relatorio-processamento.pdf}
