...
\begin{document}
	...
	\chapter{Referencial Teórico} \label{cap2-referencial}
		...
		\section{Apache Commons} \label{commons-text}
		...
		\section{Algoritmo de \textit{Jaro-Winkler}} \label{jaro-winkler}
	...
	\chapter{Desenvolvimento do \textit{IsenSys}} \label{cap3-desenvolvimento}
		...
		\section{Relatório de Similaridade}
			...
			%Algumas classes estão envolvidas na confecção deste relatório, são elas: a classe \textit{Similaridade}
